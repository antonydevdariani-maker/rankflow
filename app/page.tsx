...
import { BLOGS, getBlogById, getPublishedArticleUrl } from "@/lib/blogs";
...
export default function HomePage() {
  ...
  async function handlePublish(blogId: string, previewTab: Window | null) {
    ...
    try {
      ...
      const articleUrl = blog ? getPublishedArticleUrl(blog, slug) : null;
      if (articleUrl) {
        if (previewTab && !previewTab.closed) {
          previewTab.location.href = articleUrl;
                  ...
                  <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                    ...
                    <button
                      ...
                      onClick={() => {
                        ...
                        void handlePublish(blog.id, previewTab);
                      }}
